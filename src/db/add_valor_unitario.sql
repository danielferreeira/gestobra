-- Script para adicionar os campos valor_unitario e observacao às tabelas de movimentação de materiais
-- Execute este script se estiver encontrando erros como "column movimentacao_materiais.valor_unitario does not exist" ou "column movimentacao_materiais.observacao does not exist"
